...
<body style="background: #ededed">
           ...
           <section>
               <table class="table table-bordered">
                       <tr>
                           ...
                           <th style="width: 60px;">Name</th>
                           <td style="width: 5px;">:</td>
                           <td><asp:Label runat="server" ID="lblStudentName2"
                                                   ClientIDMode="Static"></asp:Label></td>
                           <th style="width: 120px;">Class</th>
                           <td style="width: 5px;">:</td>
                           <td><asp:Label runat="server" ID="lblClass2"
                                                   ClientIDMode="Static"></asp:Label></td>
                       </tr>
                       <tr>
                           <th style="width: 60px;">Group</th>
                           <td style="width: 5px;">:</td>
                           <td><asp:Label runat="server" ID="lblGroup2"
                                                   ClientIDMode="Static"></asp:Label></td>
                           <th style="width: 60px;">Session</th>
                           <td style="width: 5px;">:</td>
                           <td><asp:Label runat="server" ID="lblYear2"
                                                   ClientIDMode="Static"></asp:Label></td>
                           <th style="width: 120px;">Class Roll</th>
                           <td style="width: 5px;">:</td>
                           <td><asp:Label runat="server" ID="lblClassRoll2"
                                                   ClientIDMode="Static"></asp:Label></td>
                       </tr>
               </table>
           </section>
           <section>
               <div runat="server" id="divParticularCategoryList2">
    ...
    <div style="text-align: center; margin-top: 20px">
        ...
        <button class="btn-lg btn-primary" onclick="window.print()">Print Invoice</button>
    </div>
    ...
    //    mywindow.document.write(document.getElementById("printInvoice").innerHTML);
