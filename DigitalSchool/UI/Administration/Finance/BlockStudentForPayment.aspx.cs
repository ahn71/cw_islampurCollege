...
{
    public partial class BlockStudentForPayment : System.Web.UI.Page
    {
        ...
        protected void ddlGroup_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            ExamInfoEntry.GetExamIdListWithoutQuiz(ddlExam, BatchClsID[0], ddlGroup.SelectedValue);
        ...
        protected void ddlBatch_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ExamInfoEntry.GetExamIdListWithoutQuiz(ddlExam, BatchClsID[0]);
        ...
        private void loadCurrentStudentInfo()
        {
            try
            {
                ...
                string conditions = "where  rslt.Grade is not null";
                if (ddlBatch.SelectedValue != "0")
                {
                    string[] BatchClsID = ddlBatch.SelectedValue.Split('_');
                    conditions += " and  csi.BatchId='" + int.Parse(BatchClsID[0]) + "'";
                }
                ...
                if (ddlGroup.SelectedValue != "0")
                    conditions += " and csi.ClsGrpID=" + ddlGroup.SelectedValue;
                if (ddlSection.SelectedValue != "0")
                    conditions += " and csi.ClsSecID=" + ddlSection.SelectedValue;
