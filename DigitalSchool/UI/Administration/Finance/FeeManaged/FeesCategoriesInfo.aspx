	                                    ...
	                                    <div class="col-sm-10 col-sm-offset-1">   
                                            ...
                                            <asp:Panel runat="server" ClientIDMode="Static" ID="pnlClassGroupForOpen" Visible="false">
                                                 ...
                                                 <label  class="col-sm-4">Class Name</label>
                                                     <div class="col-sm-8">
                                             <asp:DropDownList runat="server" ID="ddlClassForOpen" CssClass="input controlLength form-control" OnSelectedIndexChanged="ddlClassForOpen_SelectedIndexChanged" AutoPostBack="true">
                                             ...
                                             <asp:DropDownList runat="server" ID="ddlgroupForOpen" CssClass="input controlLength form-control">
                                            ...
                                            <div class="form-group row">
                                               ...
                                               <div class="form-group row">
			                                    ...
			                                    <div class="col-sm-8">
                                                    <asp:TextBox ID="txtNote" runat="server" ClientIDMode="Static"  TextMode="MultiLine" Rows="55" CssClass="input controlLength form-control"></asp:TextBox>
			                                    </div>
		                                    </div>
